...
​
Use this card deck to design your own internal developer platform services that adhere to these four principles of an effective platform.
...
This game can be self-printed in both durable and easy access formats. The original game was printed through [Agile Stationary](https://agilestationery.com/) who provide exceptional support or you can look to go directly to printers like [CyberSecGames](https://cybersecgames.com/products/custom-poker-decks?variant=55387000832387).
...
Not all teams work in person, for those that collaborate virtually, there is a Miro template version of this game available [here](https://miro.com/templates/syntasso-stack-the-deck-promise-game/)
